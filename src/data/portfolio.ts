...
export const projects = [
  {
    ...
    title: "CodeNest",
    description:
      "A modern full-stack code snippet manager to create, organize, search, and manage reusable code snippets with syntax highlighting and instant clipboard copying.",
    tags: [
      "React",
      "Redux Toolkit",
      "Node.js",
  ...
  },
  {
    ...
    description:
      "A full-stack expense tracking app to log, categorize, and visualize personal finances. Features real-time balance updates and clean, responsive UI.",
  ...
  },
  {
    ...
    title: "AeroFlow AI",
    description:
      "An AI-powered full-stack web application built during the DecodeLabs internship. Integrates modern frontend and backend technologies with AI-driven features.",
    tags: ["React", "Node.js", "Express.js", "MongoDB"],
    github:
      "https://github.com/code-by-pawan/DecodeLabs-Internship/tree/main/Fullstack%20Project%201",
    live: "",
  ...
  },
  {
    ...
    title: "TaskFlow",
    description:
      "A collaborative task management application with intuitive workflow management. Built with a full-stack architecture for efficient project tracking.",
    tags: ["React", "Node.js", "MongoDB", "Express.js"],
    github:
      "https://github.com/code-by-pawan/DecodeLabs-Internship/tree/main/Fullstack%20Project%202",
    live: "",
  ...
  },
  {
    ...
    title: "SaaSify CRM",
    description:
      "A SaaS-based Customer Relationship Management tool designed to streamline business workflows, manage leads, and track customer interactions.",
    tags: ["React", "Node.js", "Express.js", "MongoDB"],
    github:
      "https://github.com/code-by-pawan/DecodeLabs-Internship/tree/main/Fullstack%20Project%203",
    live: "",
  ...
  },
  {
    ...
    title: "Aura Tasks",
    description:
      "A beautifully designed task management app with smooth animations and a focus on user experience. Helps manage daily to-dos efficiently.",
    tags: ["React", "Node.js", "CSS", "Express.js"],
    github:
      "https://github.com/code-by-pawan/DecodeLabs-Internship/tree/main/Fullstack%20Project%204",
    live: "",
  ...
  },
  {
    ...
    description:
      "An interactive Power BI dashboard analyzing Blinkit grocery sales data. Uncovers trends in product performance, category sales, and outlet-wise revenue.",
  ...
  },
  {
    ...
    description:
      "A comprehensive Power BI dashboard tracking mobile phone sales metrics, brand performance, regional trends, and key business KPIs.",
  ...
  },
  {
    ...
    description:
      "An insightful Power BI dashboard delivering a 360° view of sales performance including revenue trends, top products, regional analysis, and growth metrics.",
    tags: ["Power BI", "Data Analytics", "DAX", "Excel"],
