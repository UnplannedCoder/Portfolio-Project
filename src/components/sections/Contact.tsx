        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-zinc-500 max-w-2xl mx-auto text-sm">
              I'm actively looking for internship and entry-level Data Analyst / Developer roles. Have a project, opportunity, or just want to say hi? I'd love to hear from you.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants} className="space-y-7">
              ...
              {/* Social */}
              <div>
                <h4 className="text-zinc-400 text-xs font-semibold uppercase tracking-widest mb-3">Connect with me</h4>
                <div className="flex gap-3">
                  {[
                    { icon: Github, href: personalInfo.github, label: 'GitHub', sub: 'UnplannedCoder' },
                    { icon: Linkedin, href: personalInfo.linkedin, label: 'LinkedIn', sub: 'pawan-sain' },
              ...
              <div className="p-5 rounded-2xl bg-green-500/5 border border-green-500/20">
                ...
                <p className="text-zinc-500 text-sm">
                  I'm actively looking for <span className="text-zinc-300">internship</span> and <span className="text-zinc-300">entry-level roles</span> in Data Analytics and Full Stack Development. Let's build something meaningful together!
                </p>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="name" className="block text-zinc-400 text-xs font-medium mb-2">
                  ...
                  <div>
                    <label htmlFor="email" className="block text-zinc-400 text-xs font-medium mb-2">
                ...
                <div>
                  <label htmlFor="subject" className="block text-zinc-400 text-xs font-medium mb-2">
                    Subject
                  </label>
                  <input
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-zinc-400 text-xs font-medium mb-2">
                ...
                <p className="text-zinc-600 text-xs text-center">
                  ...
                  <a href={`mailto:${personalInfo.email}`} className="text-violet-400 hover:text-violet-300">
                    {personalInfo.email}
                  </a>
                </p>
              </form>
